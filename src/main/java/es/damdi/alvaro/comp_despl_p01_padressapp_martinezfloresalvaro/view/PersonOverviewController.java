...
import es.damdi.alvaro.comp_despl_p01_padressapp_martinezfloresalvaro.util.DateUtil;
...
public class PersonOverviewController {
    ...
    private void handleDeletePerson() {
        ...
        confirm.setTitle("Confirm Detection");
        confirm.setHeaderText("Delete selected person?");
        confirm.setContentText("Are you sure you want to delete this person:\n\n" + selectedPerson.getFirstName() + " " + selectedPerson.getLastName()+ "?");
